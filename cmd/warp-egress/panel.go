...
<div id="createOverlay" class="overlay">
  <div class="modal">
    ...
    <div class="modal-body">
      ...
      <div id="viaField" class="field"><label>通过已有出口注册（可选）</label><select id="createVia" class="select"><option value="">直连（默认）</option></select><div class="route-note">让 wgcf 注册请求走某个已运行的出口发出，可绕开本机 IP 的注册限流（429）。</div></div>
